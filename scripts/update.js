...
const levelBadges = (level) => {
  ...
  for (let i = 0; i < level; i++) {
    string += `![gold star](https://younes-alhyan-frontend-mentor.github.io/frontend-mentor/assets/star-filled.svg)\n`;
  }
  for (let i = level; i < 5; i++) {
    string += `![empty star](https://younes-alhyan-frontend-mentor.github.io/frontend-mentor/assets/star-outline.svg)\n`;
  }
  return string;
};
// Link Item
...
// Repo Link
const More = "https://github.com/younes-alhyan-frontend-mentor/frontend-mentor/";
//Header
